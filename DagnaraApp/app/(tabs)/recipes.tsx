...
const RECIPES = [
  ...
  { id: '77', icon: '🍱', name: 'Teriyaki Chicken Bento', diet: 'High Protein', meal: 'Lunch', kcal: 490, carbs: 58, protein: 42, fat: 10, time: '25 min', goal: 'muscle_gain', ingredients: [{ qty: '180g', name: 'Chicken thigh' }, { qty: '100g (dry)', name: 'Japanese rice' }, { qty: '80g', name: 'Edamame' }, { qty: '80g', name: 'Broccoli' }, { qty: '3 tbsp (45ml)', name: 'Teriyaki sauce' }, { qty: '1 tsp', name: 'Sesame seeds' }], steps: ['Cook rice.', 'Glaze chicken with teriyaki sauce and grill.', 'Steam broccoli and heat edamame.', 'Arrange in bento box and sprinkle sesame seeds.'] },
