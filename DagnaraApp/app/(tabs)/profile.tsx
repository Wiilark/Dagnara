...
const styles = StyleSheet.create({
  ...
  bmiCard: { backgroundColor: colors.layer2, borderRadius: radius.md, borderWidth: 1, borderColor: colors.line2, padding: spacing.sm, alignItems: 'center', gap: 2, marginBottom: spacing.xs + 2 },
  bmiSectionLbl: { fontSize: fontSize.xs, fontWeight: '700', letterSpacing: 1, color: colors.ink3, textTransform: 'uppercase' },
  bmiNum: { fontSize: fontSize['2xl'], fontWeight: '800', lineHeight: 34 },
  bmiLbl: { fontSize: fontSize.xs, color: colors.ink2, fontWeight: '500' },
  bmiScale: { flexDirection: 'row', height: 6, borderRadius: spacing.xs - 2, overflow: 'hidden', width: '100%', gap: 2, marginTop: 4 },
