...
const styles = StyleSheet.create({
  ...
  bmiCard: { backgroundColor: colors.layer2, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.line2, padding: spacing.lg, alignItems: 'center', gap: 2, marginBottom: spacing.xs + 2 },
  ...
  bmiScale: { flexDirection: 'row', height: 12, borderRadius: spacing.xs - 2, overflow: 'hidden', width: '100%', gap: 2, marginTop: spacing.sm },
