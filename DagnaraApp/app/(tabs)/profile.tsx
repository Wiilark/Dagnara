...
const styles = StyleSheet.create({
  ...
  bmiCard: { backgroundColor: colors.layer2, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.line2, padding: spacing.lg, alignItems: 'center', gap: spacing.sm, marginBottom: spacing.xs + 2 },
  bmiSectionLbl: { fontSize: fontSize.sm, fontWeight: '700', letterSpacing: 1, color: colors.ink3, textTransform: 'uppercase' },
  bmiNum: { fontSize: fontSize['2xl'] + 18, fontWeight: '800', lineHeight: 64 },
  bmiLbl: { fontSize: fontSize.md, color: colors.ink2, fontWeight: '500' },
  bmiScale: { flexDirection: 'row', height: 12, borderRadius: spacing.xs - 2, overflow: 'hidden', width: '100%', gap: 2, marginTop: spacing.xs },
