...
const fr = StyleSheet.create({
  ...
  pillP: { color: colors.macroProtein, backgroundColor: colors.macroProtein + '22', borderWidth: 1, borderColor: colors.macroProtein + '55' },
  pillC: { color: colors.macroCarbs,   backgroundColor: colors.macroCarbs   + '22', borderWidth: 1, borderColor: colors.macroCarbs   + '55' },
  pillF: { color: colors.macroFat,     backgroundColor: colors.macroFat     + '22', borderWidth: 1, borderColor: colors.macroFat     + '55' },
        ...
        {(totalFiber > 0 || totalSugar > 0 || totalSodium > 0 || totalVitaminC > 0 || totalCalcium > 0 || totalIron > 0 || totalPotassium > 0) && (
          <View style={st.microRow}>
            ...
            <View style={st.microChips}>
              {totalFiber > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: colors.microFiber }]}>{Math.round(totalFiber)}g</Text><Text style={st.microLbl}>Fiber</Text><Text style={st.microDv}>{Math.round(totalFiber / 28 * 100)}%DV</Text></View>}
              {totalSugar > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: totalSugar > 50 ? colors.rose : colors.microSugar }]}>{Math.round(totalSugar)}g</Text><Text style={st.microLbl}>Sugar</Text><Text style={[st.microDv, totalSugar > 50 && { color: colors.rose }]}>{Math.round(totalSugar / 50 * 100)}%DV</Text></View>}
              {totalSodium > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: totalSodium > 2300 ? colors.rose : colors.microSodium }]}>{Math.round(totalSodium)}mg</Text><Text style={st.microLbl}>Sodium</Text><Text style={[st.microDv, totalSodium > 2300 && { color: colors.rose }]}>{Math.round(totalSodium / 2300 * 100)}%DV</Text></View>}
              {totalVitaminC > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: colors.microVitaminC }]}>{totalVitaminC.toFixed(1)}mg</Text><Text style={st.microLbl}>Vit C</Text><Text style={st.microDv}>{Math.round(totalVitaminC / 90 * 100)}%DV</Text></View>}
              {totalCalcium > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: colors.microCalcium }]}>{Math.round(totalCalcium)}mg</Text><Text style={st.microLbl}>Calcium</Text><Text style={st.microDv}>{Math.round(totalCalcium / 1300 * 100)}%DV</Text></View>}
              {totalIron > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: colors.microIron }]}>{totalIron.toFixed(1)}mg</Text><Text style={st.microLbl}>Iron</Text><Text style={st.microDv}>{Math.round(totalIron / 18 * 100)}%DV</Text></View>}
              {totalPotassium > 0 && <View style={st.microChip}><Text style={[st.microVal, { color: colors.microPotassium }]}>{Math.round(totalPotassium)}mg</Text><Text style={st.microLbl}>Potassium</Text><Text style={st.microDv}>{Math.round(totalPotassium / 4700 * 100)}%DV</Text></View>}
            </View>
          </View>
        )}
